...
if [ -n "$CLAUDE_HISTORY_RAG_EMBEDDING_BASE_URL" ]; then
    echo "Environment=\"CLAUDE_HISTORY_RAG_EMBEDDING_BASE_URL=$CLAUDE_HISTORY_RAG_EMBEDDING_BASE_URL\"" >> "$SERVICE_DEST"
fi
if [ -n "$CLAUDE_HISTORY_RAG_EMBEDDING_MODEL" ]; then
    echo "Environment=\"CLAUDE_HISTORY_RAG_EMBEDDING_MODEL=$CLAUDE_HISTORY_RAG_EMBEDDING_MODEL\"" >> "$SERVICE_DEST"
fi
