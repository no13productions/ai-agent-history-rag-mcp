...
MANAGED_FIELDS = [
    ...
    "vertex_project",
    "vertex_location",
    "vertex_auto_truncate",
    "vertex_query_task_type",
    "vertex_document_task_type",
    "log_level",
    "debounce_delay",
    "batch_size",
    "max_file_batch_size",
    ...
    "spanner_instance",
    "spanner_database",
    "spanner_enable_full_text",
    "spanner_enable_vector_index",
    "spanner_use_approx_vector_search",
    "spanner_vector_index_leaves",
    "spanner_num_leaves_to_search",
    "spanner_hybrid_candidate_limit",
    "spanner_rrf_k",
    "spanner_embedding_mode",
    "spanner_embedding_model_id",
    "spanner_embedding_rpc_batch_size",
    "spanner_defer_embeddings",
    "spanner_backfill_concurrency",
    "spanner_backfill_batch_size",
    "spanner_backfill_interval_seconds",
...
def run_wizard() -> int:
    ...
    for field in MANAGED_FIELDS:
        if field not in new_values and field in current_values:
